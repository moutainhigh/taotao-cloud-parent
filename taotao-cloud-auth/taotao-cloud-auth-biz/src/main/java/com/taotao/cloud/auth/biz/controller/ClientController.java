...
public class ClientController {
    ...
    @SysOperateLog(description = "应用列表")
    ...
    @SysOperateLog(description = "根据id获取应用")
    @PreAuthorize("hasAuthority('sys:dict:update')")
    @GetMapping("/{clientId}")
    ...
    @SysOperateLog(description = "获取所有应用")
    @PreAuthorize("hasAuthority('sys:dict:update')")
    @GetMapping
    ...
    @SysOperateLog(description = "删除应用")
    @PreAuthorize("hasAuthority('sys:dict:update')")
    ...
    @SysOperateLog(description = "保存应用")
    @PreAuthorize("hasAuthority('sys:dict:update')")
    @PostMapping
    ...
    @SysOperateLog(description = "修改应用")
    @PreAuthorize("hasAuthority('sys:dict:update')")
    @PutMapping("/{clientId}")

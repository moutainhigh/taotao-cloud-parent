...
import com.taotao.cloud.presto.udf.component.RouteUserAggregationBase;
...
public class RouteUserGroupAggregation extends RouteUserAggregationBase {
	 ...
	 * 缓存 Buffer 头部元信息定义
	 **/
	private static int VALUES_OFFSET_HEADER_BYTE_LEN = 0;
	private static int VALUES_OFFSET_BODY_BYTE_SIZE = 4;
	private static int VALUES_OFFSET_BODY_BYTE_USED = 8;

	private static int VALUES_OFFSET_CONTAIN_TARGET_EVENT = 12;

	private static int VALUES_OFFSET_TARGET_EVENT_TYPE = 13;
	private static int VALUES_OFFSET_ROUTE_INTERVAL = 17;
	private static int VALUES_OFFSET_TARGET_EVENT_LEN = 21;
	private static int VALUES_OFFSET_TARGET_EVENT_BYTES = 25;

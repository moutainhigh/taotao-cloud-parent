...
public class FtpClient {
    ...
    private static Logger logger = LoggerFactory.getLogger("FtpClient");
    private String host; // FTP地址
    ...
    public FtpClient(String host, String port, String username, String passwd, String remoteDir) {
        this.host = host;
        this.port = port;
    ...
    public FtpClient(String host, String port, String username, String passwd) {
